...
const ContactCard = ({
  ...
  const openWhatsApp = (phone: string) => {
    ...
    window.open(`https://wa.me/${formattedPhone.replace(/\+/g, '')}`, '_blank');
  };
  ...
  const shareViaWhatsApp = (phone: string) => {
    ...
    window.open(`https://wa.me/${formattedPhone.replace(/\+/g, '')}?text=${encodedMessage}`, '_blank');
  ...
  return (
    <div className="w-full max-w-sm py-10">
      <h1 className="text-center text-xl md:text-2xl font-medium mb-6 text-white leading-tight bg-transparent">
